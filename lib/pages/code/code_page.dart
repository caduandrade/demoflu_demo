...
class CodePage extends DemoFluPage {
  ...
  void initialize(BuildContext context) {
    ...
    code('lib/pages/code/simple_code_page.dart', title: 'Example');
    ...
    code('lib/pages/code/assets.txt', title: 'Assets example in pubspec.yaml');
    ...
    code('lib/pages/code/fonts.txt', title: 'Example of a monospaced font');
  }
}
