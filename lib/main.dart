...
import 'package:demoflu_demo/pages/bullets/bullets_page.dart';
...
void main() {
  DemoFluApp app = DemoFluApp(title: 'DemoFlu (2.3.0)', rootMenus: _rootMenus);
...
List<DemoMenuItem> get _rootMenus => [
      ...
      DemoMenuItem('Page sections', children: [
        ...
        DemoMenuItem('Bullets', page: () => BulletsPage()),
